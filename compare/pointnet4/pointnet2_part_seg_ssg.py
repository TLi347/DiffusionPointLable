...
from compare.pointnet4.pointnet2_utils import PointNetSetAbstraction,PointNetFeaturePropagation


class pointnet2_part_seg_ssg(nn.Module):
    def __init__(self, num_classes, normal_channel=False):
        super(pointnet2_part_seg_ssg, self).__init__()
        if normal_channel:
